...
Blockly.CSharp.procedures_defreturn = function() {
	...
	for (var x = 0; x < this.arguments_.length; x++)
		args[x] = Blockly.CSharp.variableDB_.getName(this.arguments_[x], Blockly.Variables.NAME_TYPE);
...
Blockly.CSharp.procedures_callreturn = function() {
	...
	var funcName = Blockly.CSharp.variableDB_.getName(this.getFieldValue('NAME'), Blockly.Procedures.NAME_TYPE);
	var args = [];
	for (var x = 0; x < this.arguments_.length; x++)
